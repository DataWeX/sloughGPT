...
See **`standards/MAN_STANDARD_V1.md`** (and **`packages/standards/standards/v1/`** for schemas). Native trainer **`step_*.pt`** char vocabulary (outside these JSON schemas) is documented in **`docs/policies/CONTRIBUTING.md`** (*Checkpoint vocabulary*).
