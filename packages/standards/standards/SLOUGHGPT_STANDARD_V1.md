...
| This document | `standards/SLO_STANDARD_V1.md` |
...
- **Standard revision**: bump `standards/SLO_STANDARD_V1.md` header and schemas under `standards/v1/`; keep old schemas as `standards/v0/` if needed later.
