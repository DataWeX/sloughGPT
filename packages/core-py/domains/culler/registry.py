...
class CullerRegistry:
    def __init__(self):
        self._sources: dict[str, Source] = {}
        self._stores: dict[str, Store] = {}
        self._filters: dict[str, Filter] = {}
        self._pipelines: dict[str, CullerPipeline] = {}
    ...
    def create_pipeline(self, name: str, source_name: str, store_name: str, filter_names: list[str] | None = None) -> CullerPipeline | None:
        ...
        if filter_names:
            for fn in filter_names:
                ...
                if f is not None:
                    filters.append(f)
        pipeline = CullerPipeline(source, store, filters, name=name)
        self._pipelines[name] = pipeline
        return pipeline

    def get_pipeline(self, name: str) -> CullerPipeline | None:
...
_default_registry: CullerRegistry | None = None


def get_registry() -> CullerRegistry:
    global _default_registry
    if _default_registry is None:
        _default_registry = CullerRegistry()
