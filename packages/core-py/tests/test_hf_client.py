...
class TestHFClient:
    def test_api_mode_init(self):
        with patch("domain.training._internal.huggingface.client._APILoader") as MockLoader, \
    ...
    def test_local_mode_init(self):
        with patch("domain.training._internal.huggingface.client._APILoader"), \
...
class TestGetModelMemory:
    def test_returns_dict(self):
        with patch("domain.training._internal.huggingface.client.get_model_requirements") as mock_req:
...
class TestListModels:
    def test_list_all(self):
        ...
        with patch("domain.training._internal.huggingface.model_map.search_models") as mock_search, \
