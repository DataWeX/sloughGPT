...
class TestGenome:
    ...
    def test_from_baby(self):
        params = WorldParams(cells_input_dim=5, body_input_dim=3, entity_input_dim=5)
    ...
    def test_random_with_hidden(self):
        params = WorldParams(
            cells_input_dim=5, body_input_dim=3, entity_input_dim=5, brain_hidden_units=4
        )
        rng = np.random.default_rng(42)
...
class TestEvolutionEngine:
    ...
    def test_group_means(self):
        ...
        genomes = [
            Genome.random(params, np.random.default_rng(0), group_id=0),
