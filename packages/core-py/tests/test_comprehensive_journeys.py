...
class TestSiteConfig:
    ...
    def test_training_subpages_exist(self):
        for key in [
            "training/runs", "training/presets", "training/analytics",
            "training/compare", "training/trends", "training/insights",
            "training/model-card", "training/grid-search",
        ]:
            assert key in SLOUGHPGPT_PAGES, f"Missing training page: {key}"

    def test_consciousness_subpages_exist(self):
        for key in [
            "consciousness/dashboard", "consciousness/debug",
            "consciousness/testing", "consciousness/analytics",
            "consciousness/insights", "consciousness/monitor",
        ]:
    ...
    def test_pages_have_valid_paths(self):
        for key, (path, checks) in SLOUGHPGPT_PAGES.items():
            assert path == "" or path.startswith("/"), f"Page {key} path must be empty or start with /: {path}"
