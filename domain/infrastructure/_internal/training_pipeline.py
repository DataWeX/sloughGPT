...
class Conversation:
    ...
    feedback: str | None = None  # FEEDBACK_UP, FEEDBACK_DOWN, FEEDBACK_NEUTRAL, or None
...
class TrainingDataPipeline:
    ...
    def _migrate_from_json(self):
        ...
        for name, col in (
            ...
            if records:
                logger.info("Migrated %d legacy records from %s into MogDB", len(records), name)
    ...
    @staticmethod
    def _quality_for_feedback(feedback: str | None) -> float:
    ...
    @staticmethod
    def _score_quality(feedback: str | None, response: Any) -> float:
    ...
    def add_feedback(self, conversation_id: str, feedback: str | None) -> bool:
    ...
    def _update_pair_quality(self, conversation: dict, feedback: str | None):
    ...
    def update_training_run(self, run_id: str, status: str, metrics: dict | None = None):
    ...
    def get_training_runs(self, limit: int | None = 10) -> list[TrainingRun]:
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "conversations_with_feedback": len([c for c in convs if c.get("feedback")]),
                ...
                "exports_count": len(
                    [p for p in self.exports_dir.glob("*.jsonl") if p.name != "latest.jsonl"]
                ),
            }
...
# Singleton
_pipeline: TrainingDataPipeline | None = None
