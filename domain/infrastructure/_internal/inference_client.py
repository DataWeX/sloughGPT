...
class InferenceClient:
    ...
    def reload(self, model_id: str, slnc_path: str | None = None) -> dict:
    ...
    def _send_and_recv(self, msg: dict, timeout: float = 30.0) -> dict | None:
            ...
            try:
                ...
                if self._try_reconnect():
                    try:
                        ...
                        logger.error(
                            "InferenceClient: reconnect+send failed",
                            extra={
                                "host": self.host,
                                "port": self.port,
                                "error": str(e2),
    ...
    def _send_and_recv_unlocked(self, msg: dict) -> dict | None:
