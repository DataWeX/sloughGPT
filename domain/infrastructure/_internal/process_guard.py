...
from .constants import DEFAULT_GENERATE_TIMEOUT, DEFAULT_STALL_TIMEOUT
            ...
            if self._restart_count >= self.max_restarts:
                logger.error(
                    ...
                    extra={
                        ...
                        "ok": False,
                        "err": {
                            "code": "E_GUARD_EXHAUSTED",
                            "msg": "worker restart budget exhausted",
                        },
    ...
    def _monitor_loop(self) -> None:
        while not self._stop_monitor.is_set():
            ...
            if not worker.alive and restarts_left:
                ...
                logger.error(
                    "process_guard: worker dead, restart budget exhausted",
                    extra={
                        "worker_id": self.worker_id,
                        "model_id": self._model_id,
