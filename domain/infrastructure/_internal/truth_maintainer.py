...
Usage:
    from .truth_maintainer import TruthMaintainer
...
class TruthMaintainer:
    ...
    def __init__(self, labeler: TruthLabeler | None = None):
    ...
    def apply_correction(
        ...
        grad_emb = (grad_query / norms) - (
            query_emb.data * (grad_query * query_emb.data).sum(axis=1, keepdims=True) / (norms**3)
        )
...
_maintainer: TruthMaintainer | None = None
