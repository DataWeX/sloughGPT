...
export const NAV_SECTIONS: NavSectionDef[] = [
  {
    ...
    routes: [
      ...
      { path: '/self-train', labelKey: 'nav.self_train', icon: 'brain', description: 'Autonomous self-training' },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/souls', labelKey: 'nav.souls', shortcut: '6', icon: 'brain', description: 'Trained model souls & checkpoints' },
      { path: '/personality', labelKey: 'nav.personality', icon: 'brain', description: 'Runtime personality configuration' },
      { path: '/consciousness', labelKey: 'nav.consciousness', icon: 'sparkle', description: 'Cognitive engine (core)' },
