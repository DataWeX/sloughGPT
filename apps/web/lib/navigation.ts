  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        icon: 'settings',
        description: 'Plugins & cloud training',
      },
    ],
  },
  {
    ...
    routes: [
      {
        ...
        labelKey: 'nav.workspace_dashboard',
        icon: 'activity',
      ...
      {
        path: '/shared-data',
        labelKey: 'nav.shared_data',
        icon: 'users',
        description: 'Cross-workspace data sharing',
      },
      {
        path: '/shortcuts',
