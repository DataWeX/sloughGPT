...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    'nav.memory': 'Memory',
    'nav.lora-eval': 'LoRA Eval',
    'nav.rate-limit': 'Rate Limit',
    'nav.evaluate': 'Evaluate',
    'nav.self-train': 'Self-Train',
    'nav.collections': 'Collections',
    'nav.docstore': 'Document Store',
    'nav.admin': 'Admin',
    'nav.session': 'Session Inspector',
    'nav.shell': 'Shell',
    'nav.kb': 'Knowledge Base',
    'nav.token-tree': 'Token Tree',
    'nav.vector': 'Vector Store',
    'nav.meta-weights': 'Meta Weights',
    'nav.infer': 'API Console',
    'nav.world': 'World Rendering',
    'nav.learn': 'Learn',
  ...
  es: {
    ...
    'nav.meta-weights': 'Pesos Meta',
    'nav.infer': 'Consola API',
    'nav.world': 'Render Mundo',
    'nav.learn': 'Aprender',
    ...
    'nav.memory': 'Memoria',
    'nav.lora-eval': 'Eval LoRA',
    'nav.rate-limit': 'Límite de Velocidad',
    'nav.evaluate': 'Evaluar',
    'nav.self-train': 'Auto-Entreno',
    'nav.collections': 'Colecciones',
    'nav.docstore': 'Documentos',
    'nav.admin': 'Admin',
    'nav.session': 'Inspector Sesión',
    'nav.shell': 'Shell',
    'nav.kb': 'Base de Conocimiento',
    'nav.token-tree': 'Árbol de Tokens',
  ...
  fr: {
    ...
    'nav.meta-weights': 'Poids Meta',
    'nav.infer': 'Console API',
    'nav.world': 'Rendu Monde',
    'nav.learn': 'Apprendre',
    ...
    'nav.memory': 'Mémoire',
    'nav.lora-eval': 'Éval LoRA',
    'nav.rate-limit': 'Limitation de Débit',
    'nav.evaluate': 'Évaluer',
    'nav.self-train': 'Auto-Entraînement',
    'nav.collections': 'Collections',
    'nav.docstore': 'Documents',
    'nav.admin': 'Admin',
    'nav.session': 'Inspecteur Session',
    'nav.kb': 'Base de Connaissances',
    'nav.token-tree': 'Arbre de Tokens',
    'nav.section.core': 'Principal',
    'nav.section.ai': 'IA',
  ...
  de: {
    ...
    'nav.meta-weights': 'Meta-Gewichte',
    'nav.infer': 'API-Konsole',
    'nav.world': 'Welt-Rendering',
    'nav.learn': 'Lernen',
    ...
    'nav.memory': 'Speicher',
    'nav.lora-eval': 'LoRA-Bewertung',
    'nav.rate-limit': 'Ratenbegrenzung',
    'nav.evaluate': 'Bewerten',
    'nav.self-train': 'Selbst-Training',
    'nav.collections': 'Sammlungen',
    'nav.docstore': 'Dokumente',
    'nav.admin': 'Admin',
    'nav.session': 'Sitzungs-Inspector',
    'nav.shell': 'Shell',
    'nav.kb': 'Wissensbasis',
    'nav.token-tree': 'Token-Baum',
