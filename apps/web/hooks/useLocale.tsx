...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    'nav.workspace_api_keys': 'API Keys',
  ...
  es: {
    ...
    'nav.workspace_api_keys': 'Claves API',
  ...
  fr: {
    ...
    'nav.workspace_api_keys': 'Clés API',
  ...
  de: {
    ...
    'nav.workspace_api_keys': 'API-Schlüssel',
    'home.subtitle.offline': 'Offline',
