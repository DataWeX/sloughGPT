...
export default function SettingsPage() {
  ...
  return (
    <PageContainer title="Settings">
      {/* ── Personalization ─────────────────────────────────── */}
      <SectionHeader title="Personalization" description="Theme, palette, and language" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            {settings.theme !== 'light' && (
              <Button size="sm" variant="ghost" className="h-7 text-[11px] text-muted-foreground" onClick={() => updateSettings({ theme: 'light' })}>
                Reset
              </Button>
            )}
          </div>
          ...
          <div className="p-2.5 rounded-lg border border-border/50 bg-card/50">
            ...
            <div className="flex gap-1 mt-1.5">
              <div className="h-4 px-1.5 rounded bg-primary text-[7px] text-primary-foreground flex items-center justify-center">Btn</div>
              <div className="h-4 px-1.5 rounded bg-muted text-[7px] text-muted-foreground flex items-center justify-center">Sec</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="p-2.5 rounded-lg border border-border/50 bg-card/50">
            ...
            <div className="flex gap-1 mt-1.5">
              <div className="h-4 px-1.5 rounded bg-primary text-[7px] text-primary-foreground flex items-center justify-center">Pri</div>
              <div className="h-4 px-1.5 rounded bg-accent text-[7px] text-accent-foreground flex items-center justify-center">Acc</div>
            </div>
          </div>
        </div>
      ...
      {/* ── Connection ──────────────────────────────────────── */}
      <SectionHeader title="Connection" description="Service endpoint and authentication" />
      ...
      {/* ── Generation ──────────────────────────────────────── */}
      <SectionHeader title="Generation" description="Default model and generation settings" />
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-border/40">
            ...
            <Button size="sm" variant="ghost" className="h-7 text-[11px] text-muted-foreground" onClick={() => updateSettings({ defaultTemp: DEFAULT_SETTINGS.defaultTemp, defaultMaxTokens: DEFAULT_SETTINGS.defaultMaxTokens, defaultTopP: DEFAULT_SETTINGS.defaultTopP, defaultTopK: DEFAULT_SETTINGS.defaultTopK })}>
              Reset
            </Button>
          </div>
        </CardContent>
      ...
      {/* ── Memory ──────────────────────────────────────────── */}
      <SectionHeader title="Memory" description="Custom instructions included with every prompt" />
      ...
      {/* ── System health ───────────────────────────────────── */}
      <SectionHeader title="System" description="Backend status and resource usage" />

      {healthError && !detailed && !metrics ? (
        <Card>
          <CardContent className="py-6 flex flex-col items-center gap-3 text-center">
            <p className="text-sm text-destructive">Could not connect to service</p>
      ...
      <FoldSection heading="Chat commands">
        <p className="mb-2">Type <kbd className="inline-flex items-center rounded border border-border/40 bg-muted px-1.5 py-0.5 text-[11px] font-mono">/</kbd> in chat to open the command palette</p>
      ...
      <FoldSection heading="Keyboard shortcuts">
        <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-sm">
          {[
      ...
      {info && (
        <FoldSection heading="System information">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
      ...
      <FoldSection heading="Backup & restore">
      ...
      <FoldSection heading="Process isolation">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm text-muted-foreground">Run model inference in a separate process for crash safety</p>
          {processGuard && (
            <Switch
      ...
      {/* ── Danger zone ─────────────────────────────────────── */}
      <div className="rounded-lg border border-destructive/25 bg-destructive/[0.03] p-4 space-y-3">
