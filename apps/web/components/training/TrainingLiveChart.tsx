    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {chartData.length > 1 ? (
          ...
          <div className="h-40 flex items-center justify-center text-[10px] text-muted-foreground/60">
            Waiting for loss data...
          </div>
        )}

        {stepsPerSec != null && stepsPerSec > 0 && (
          <div className="text-[9px] text-muted-foreground/60 text-right tabular-nums">
