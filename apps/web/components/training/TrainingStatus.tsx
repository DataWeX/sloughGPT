...
export function TrainingProgress({ status }: { status: string }) {
  return (
    <div className="space-y-2" role="status" aria-live="polite" aria-label="Training progress" aria-atomic="true">
...
export function TrainingCompleteBanner({
  ...
  return (
    <div className="rounded-lg border border-success/20 bg-success/5 p-3 space-y-2" role="status" aria-live="polite">
