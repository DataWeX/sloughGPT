...
describe('QuickImportDialog', () => {
  ...
  it('renders the dialog when open', () => {
    render(<QuickImportDialog open onOpenChange={() => {}} onImported={() => {}} />)
  ...
  it('renders nothing when closed', () => {
    const { container } = render(<QuickImportDialog open={false} onOpenChange={() => {}} onImported={() => {}} />)
  ...
  it('imports from a local path with the default name', async () => {
    ...
    render(<QuickImportDialog open onOpenChange={() => {}} onImported={onImported} />)
  ...
  it('closes the dialog via the Done button and resets state', async () => {
    ...
    render(<QuickImportDialog open onOpenChange={onOpenChange} onImported={() => {}} />)
    fireEvent.change(screen.getByPlaceholderText('/path/to/dataset/folder'), { target: { value: '/data' } })
    fireEvent.click(screen.getByRole('button', { name: 'Import' }))
    await waitFor(() => expect(screen.getByText('Imported successfully')).toBeDefined())
