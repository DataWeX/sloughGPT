...
function Swatch({ rgb, label, description }: { rgb: string; label: string; description?: string }) {
  return (
    <div className="flex flex-col items-center gap-1.5">
      <div
        className="h-12 w-12 rounded-md border border-border/40 shadow-sm transition-transform hover:scale-110"
...
export function ColorPaletteCard({ title, colors }: ColorPaletteCardProps) {
  return (
