...
class TestCmdTrainAndQuery:
    ...
    def test_train_round_trips_through_cli_helpers(self, corpus_file, tree_args):
        from commands.token_tree import _load_tree, cmd_token_tree_train
    ...
    def test_stdin_encode_reads_stdin(self, corpus_file, tree_args, monkeypatch, mock_log):
        from commands.token_tree import cmd_token_tree_encode, cmd_token_tree_train
    ...
    def test_similar_runs_on_trained_tree(self, corpus_file, tree_args, mock_log):
        from commands.token_tree import cmd_token_tree_similar, cmd_token_tree_train
    ...
    def test_lineage_decomposes_token(self, corpus_file, tree_args, mock_log):
        from commands.token_tree import cmd_token_tree_lineage, cmd_token_tree_train
...
class TestCmdEmbeddingAndPath:
    def test_embedding_shows_dim_and_norm(self, corpus_file, tree_args, mock_log):
        from commands.token_tree import cmd_token_tree_embedding, cmd_token_tree_train
    ...
    def test_path_traces_steps_and_ids(self, corpus_file, tree_args, mock_log):
        from commands.token_tree import cmd_token_tree_path, cmd_token_tree_train
    ...
    def test_path_round_trips_through_cli(self, corpus_file, tree_args):
        from commands.token_tree import _load_tree, cmd_token_tree_path, cmd_token_tree_train
...
class TestCmdMatrix:
    def test_matrix_shows_shape_and_norm_stats(self, corpus_file, tree_args, mock_log):
        from commands.token_tree import cmd_token_tree_matrix, cmd_token_tree_train
...
class TestCmdMerges:
    def test_merges_prints_ranked_pairs(self, corpus_file, tree_args, mock_log):
        from commands.token_tree import cmd_token_tree_merges, cmd_token_tree_train
...
class TestCmdSavedTrees:
    ...
    def test_save_adopts_tree_from_path(self, tmp_path, monkeypatch, mock_log):
        from commands.token_tree import cmd_token_tree_save, cmd_token_tree_train
        ...
        monkeypatch.setattr(
            "domain.training._internal.token_tree_manager._SAVE_DIR", tmp_path / "save"
        )
        from domain.training._internal.token_tree_manager import get_token_tree_manager
