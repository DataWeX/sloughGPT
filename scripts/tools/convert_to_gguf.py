...
Usage:
    python3 scripts/tools/convert_to_gguf.py --input models/sloughgpt_finetuned.pt --output dist/models/sloughgpt-q4_k_m.gguf
...
Next steps:
  1. Start model server: python3 scripts/tools/model_server.py
